...
export function SubmissionCard({ submission, showChallenge = true, challengeTitle, onDownload }: SubmissionCardProps) {
      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            {showChallenge && challengeTitle && (
              <p className="text-sm text-muted-foreground mb-1">{challengeTitle}</p>
            )}
